  ...
  return (
    <AdminLayout>
      <div className="space-y-6 max-w-4xl">
        <h1 className="text-2xl font-bold text-foreground">Granted Access</h1>

        <Card>
          <CardHeader><CardTitle className="text-base">Grant Premium Access</CardTitle></CardHeader>
          <CardContent>
          ...
          <CardContent className="p-0">
            <Table>
              ...
              <TableBody>
                ...
                {filtered.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={6} className="text-center text-muted-foreground py-8">No granted access entries</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
