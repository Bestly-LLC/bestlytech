...
export default function TermsOfService() {
  ...
  const sections = [
    { id: "1", title: "1. Agreement to Terms", content: (
      <>
    ...
    { id: "2", title: "2. Eligibility", content: (
      <p className="text-muted-foreground leading-relaxed">
    ...
    { id: "3", title: "3. Account Registration", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "4", title: "4. Software License", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "5", title: "5. Physical Products", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "6", title: "6. Prohibited Uses", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "7", title: "7. Intellectual Property", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "8", title: "8. User Content", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "9", title: "9. Third-Party Services", content: (
      <p className="text-muted-foreground leading-relaxed">
    ...
    { id: "10", title: "10. Payments and Refunds", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "11", title: "11. Disclaimer of Warranties", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "12", title: "12. Limitation of Liability", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "13", title: "13. Indemnification", content: (
      <p className="text-muted-foreground leading-relaxed">
    ...
    { id: "14", title: "14. Governing Law", content: (
      <p className="text-muted-foreground leading-relaxed">
    ...
    { id: "15", title: "15. Dispute Resolution and Arbitration", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "16", title: "16. Termination", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    { id: "17", title: "17. Changes to Terms", content: (
      <p className="text-muted-foreground leading-relaxed">
    ...
    { id: "20", title: "20. Contact Us", content: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
