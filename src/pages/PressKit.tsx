          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                {[
                  { icon: Building2, title: "About Bestly", link: "/about", text: "Learn more" },
                  { icon: FileText, title: "Legal Documents", link: "/terms", text: "View policies" },
                  { icon: Image, title: "All Products", link: "/products", text: "View portfolio" },
                  { icon: Mail, title: "General Contact", link: "/contact", text: "Get in touch" },
                ].map((item, index) => (
