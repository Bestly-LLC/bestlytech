...
export const Step7Review = () => {
  const { formData, setCurrentStep, goBack, formId, uploadedDocs, saveNow, setStatus } = useIntakeForm();
      ...
      <Card>
        <CardContent className="py-12 text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            We'll review your information and get started on your Amazon Seller account setup. You'll hear from us within 1-2 business days.
          </p>
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <Section title="Client Contact Info" step={0}>
          ...
          <Field label="Platform" value={formData.platform} />
        </Section>
        ...
        <Section title="Brand & Products" step={4}>
      ...
      <Dialog open={showConfirm} onOpenChange={setShowConfirm}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Once submitted, our team will review your information and begin the Amazon account setup. You'll be notified of any issues or when setup is complete.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
