  ...
  return (
    <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl overflow-hidden">
      <div className="flex items-center gap-2 px-5 py-4">
        ...
        <div>
          <h3 className="text-[0.9375rem] font-semibold text-white">Activity Feed</h3>
          <p className="text-xs text-white/50 mt-0.5">Recent events across the admin suite.</p>
        </div>
      </div>
            ...
            return (
              <div key={e.id} className="flex items-start gap-3 px-5 py-3 hover:bg-white/[0.02] transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-white/50 mt-0.5">{timeAgo(e.created_at)}</p>
                </div>
                <Badge variant="outline" className="text-[0.625rem] shrink-0 border-white/10 text-white/50">
